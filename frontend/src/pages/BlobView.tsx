  ...
  function renderContent() {
    ...
    if (isMarkdown(fileName)) {
      if (markdownViewMode === "code") {
        ...
        return <CodeViewer code={blob.content} language="markdown" fileName={fileName} filePath={path} absolutePath={absPath} />;
      }
    ...
    <Layout>
      <div className="max-w-5xl mx-auto p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          {isMarkdown(fileName) && (
            <div className="ml-auto inline-flex rounded-md border border-[#d0d7de] overflow-hidden">
              <button
              ...
              <button
                ...
                className={`px-3 py-1.5 text-sm font-medium border-l border-[#d0d7de] cursor-pointer ${
